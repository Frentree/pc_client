...
from lib.watchdog.utils import platform
...
from lib.watchdog.observers.api import (
    BaseObserver,
    EventEmitter,
...
from lib.watchdog.utils.dirsnapshot import DirectorySnapshot

from lib.watchdog.events import (
    DirMovedEvent,
    DirDeletedEvent,
    DirCreatedEvent,
    DirModifiedEvent,
