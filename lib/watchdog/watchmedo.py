...
from lib.watchdog.version import VERSION_STRING
from lib.watchdog.utils import WatchdogShutdown, load_class
...
def log(args):
    ...
    :param args:
        Command line argument options.
    """
    from lib.watchdog.utils import echo
    from lib.watchdog.tricks import LoggerTrick
    ...
    if args.debug_force_polling:
        from lib.watchdog.observers.polling import PollingObserver as Observer
    elif args.debug_force_kqueue:
        from lib.watchdog.observers.kqueue import KqueueObserver as Observer
    elif args.debug_force_winapi_async:
        from lib.watchdog.observers.read_directory_changes_async import\
            WindowsApiAsyncObserver as Observer
    elif args.debug_force_winapi:
        from lib.watchdog.observers.read_directory_changes import\
            WindowsApiObserver as Observer
    elif args.debug_force_inotify:
        from lib.watchdog.observers.inotify import InotifyObserver as Observer
    elif args.debug_force_fsevents:
        from lib.watchdog.observers.fsevents import FSEventsObserver as Observer
    else:
...
def shell_command(args):
    ...
    :param args:
        Command line argument options.
    """
    from lib.watchdog.tricks import ShellCommandTrick
...
def auto_restart(args):
    ...
    from lib.watchdog.tricks import AutoRestartTrick
    import signal
